...
\begin{multline}
E_0 \left( u \left( \frac{\Lambda_T}{\Lambda_0} (S_T - X) \right) \right) = -\int\limits_{S_T = X}^{+\infty} \left( \frac{\Lambda_T(\varepsilon)}{\Lambda_0}
(S_T(\varepsilon) - X) \right)^\alpha dw^+(1 - F(\varepsilon)) - \\ - \lambda \int\limits_{S_T = -\infty}^X \left( \frac{\Lambda_T(\varepsilon)}{\Lambda_0}
(X - S_T(\varepsilon)) \right)^\beta dw^-(F(\varepsilon)).
\end{multline}
\end{document}
